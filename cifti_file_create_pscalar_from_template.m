function cifti = cifti_file_create_pscalar_from_template(ciftitemplate, data, varargin)
    %function cifti = cifti_file_create_pscalar_from_template(ciftitemplate, data, ...)
    ...
    %
    %   newcifti = cifti_file_create_pscalar_from_template(oldcifti, newdata, 'namelist', {'sulc', 'curv'});
