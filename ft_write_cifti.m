...
%
% $Id: ft_write_cifti.m 9838 2014-09-24 20:05:14Z roboos $
...
if any(strcmp(dimtok, 'chan'))
  ...
  for i=1:numel(parcel)
    selParcel = source.parcellation==find(strcmp(source.parcellationlabel, parcel{i}));
    structure = source.brainstructurelabel(unique(source.brainstructure(selParcel)));
    ...
    for j=1:length(structure)
      selStructure = source.brainstructure==find(strcmp(source.brainstructurelabel, structure{j}));
