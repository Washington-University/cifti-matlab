function cifti = cifti_dense_replace_volume_all(cifti, data, cropped, dimension)
    %function cifti = cifti_dense_replace_volume_all(cifti, data, cropped, dimension)
    ...
    [voxlist1, ciftilist, voldims, ~] = cifti_dense_get_vol_all_mapping(cifti.diminfo{dimension}, cropped);
