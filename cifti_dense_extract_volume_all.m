function [outdata, outsform1, outroi] = cifti_dense_extract_volume_all(cifti, cropped, dimension)
    %function [outdata, outsform1, outroi] = cifti_dense_extract_volume_all(cifti, cropped, dimension)
    ...
    [voxlist1, ciftilist, voldims, outsform1] = cifti_dense_get_vol_all_mapping(cifti.diminfo{dimension}, cropped);
