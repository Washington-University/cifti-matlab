function cifti = cifti_file_create_dscalar_from_template(ciftitemplate, data, varargin)
    %function cifti = cifti_file_create_dscalar_from_template(ciftitemplate, data, ...)
    ...
    %   contents of the scalar diminfo, like:
    %
    %   >> newcifti = cifti_file_create_dscalar_from_template(oldcifti, newdata, 'namelist', {'sulc', 'curv'});
